<template>
    <div>
        <h4>基本用法</h4>
        <div>
            <yd-cell title="我是标题" desc="描述文字">
            </yd-cell>
            <yd-cell :showIcon="true" title="我是标题" subTitle="我是副标题" desc="展示默认ICON">
            </yd-cell>
            <yd-cell :isLink="true" linkUrl="//m.jd.com" :showIcon="true" title="带链接">
            </yd-cell>
        </div>
        <h4>通过Slot插槽分发内容</h4>
        <div>
            <yd-cell :isLink="true" :showIcon="true">
                <span slot="title">我是主标题</span>
                <span slot="sub-title">我是副标，我们都是通过Slot分发的</span>
                <span slot="desc">我是描述</span>
            </yd-cell>
            <yd-cell :showIcon="true">
